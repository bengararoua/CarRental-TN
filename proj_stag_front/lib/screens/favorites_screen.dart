...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  Widget _buildBody(List<Map<String, dynamic>> favorites) {
    ...
    return GridView.builder(
      ...
      //gridDelegate : la règle qui définit comment la grille est organisée
      //SliverGridDelegate:un objet qui définit comment une grille est organisée dans un GridView
