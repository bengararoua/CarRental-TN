...
class _AllVehiclesScreenState extends State<AllVehiclesScreen> {
  ...
  Future<void> _deleteVehicle(int vehicleId, String vehicleName) async {
    ...
    // Si annule, on quitte la fonction
    ...
    showDialog(
      context: context,
      //barrierDismissible:détermine si l’utilisateur peut fermer la boîte en cliquant en dehors.
 ...
 // Modifier un véhicule
      ...
      builder: (context, provider, child) {
        ...
        if (provider.allVehicles.isNotEmpty && _maxPriceFound == 200.0) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            ...
            //reduce():réduire une liste en une seule valeur
  ...
  // Construit un menu déroulant (Dropdown) 
